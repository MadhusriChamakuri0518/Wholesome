      ...
      <div className="p-10 flex flex-col gap-4 md:flex-row">
        <div className="md:w-1/2 md:pl-4">
          ...
          <p className="my-4 md:pr-8 text-xl">
            Please share your contact details and some of your preferences so
            that we can help you get started with Wholesome. We'll get in touch
            with you soon to discuss next steps!
          </p>
          <div className="py-2">
